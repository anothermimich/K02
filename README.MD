...
The `rev. 02` introduces an hybrid version of the `USB-C` version. It remains in development and so it's _untested_, someday it will be compatible with kailh choc switches v1 and v2 using choc spaced keycaps.
