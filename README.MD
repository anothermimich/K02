...
The `rev. 02` are under development. It will introduce an choc V1 and V2 hybrid version of the `USB-C` version and a new choc V1 version specific for the CFX keycaps (16,5mm x 16,5mm) with an reduced pcb size (less than 100mm x 100mm) and on top of that it will support 36 keys for wireless boards.
