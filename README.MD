...
The `rev. 02` introduces an hybrid version of the `USB-C` pcb. This version remains _untested_, in theory it's compatible with kailh choc switches v1 and v2. Beware that the keycaps need to be choc spaced.
